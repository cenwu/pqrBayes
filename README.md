...
#### robust Bayesian shrinkage estimation under group LASSO
    ...
    # RBGL, or Bayesian quantile group LASSO, Li, Xi and Lin. Bayesian Anal. (2010)
    ...
    # BGLSS, Bayesian group LASSO with spike-and-slab priors, Xu and Ghosh Bayesian Anal. (2015) 
    ...
    # BGL, Bayesian group LASSO, Casella et al. Bayesian Anal. (2010) 
